...
class Boiler:
    ...
    def increase_temperature(self, amount):
        print('increasing the boiler temperature by {} defrees'.format(amount))
...
class Fridge:
    ...
    def increase_temperature(self, amount):
        print('increasing the fridge temperature by {} defrees'.format(amount))
        self.temperature += amount
...
def main():
    ...
    for t in tests:
        if len(event.parseString(t)) == 2:
            ...
            if 'open' in cmd_str or 'turn off' in cmd_str:
